...
This file provides instructions and context for AI coding agents working on this project. See [AGENTS.md](./AGENTS.md) for the `elv` usage contract (envelopes, exit codes, safety, discovery).
